...
int main( int argc, char **argv )
{
    ...
    {
        result = xmssMtVerifySignatureFlash( msg, msgLen, sigOffset, sigLen, key, keyLen, scratchBuff, scratchLen );
    }
    else
    {
        result = xmssVerifySignatureFlash( msg, msgLen, sigOffset, sigLen, key, keyLen, scratchBuff, scratchLen );
    }
