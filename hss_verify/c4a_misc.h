...
/*----------------------------------------------------------------------------------------------------*/
    ...
    sig_retcode_t otsVerifySignature( const void *message, size_t messageLen, const unsigned char *signature,
                                      size_t signatureLen, const unsigned char *publicKey, size_t publicKeyLen );
    sig_retcode_t lmsValidatePublicKey( const unsigned char *publicKey, size_t publicKeyLen );
    sig_retcode_t otsValidatePublicKey( const unsigned char *publicKey, size_t publicKeyLen );
